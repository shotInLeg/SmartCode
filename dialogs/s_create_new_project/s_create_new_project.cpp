    ...
    ui(new Ui::SCreateNewProject)
{
    ...
    ui->eInterpreterPath->setText(baseInterpreterPath);
    this->baseProjectPath = baseProjectPath;
    ui->eProjectPath->setText(baseProjectPath);
...
void SCreateNewProject::on_bCreate_clicked()
{
    ...
    emit createProject(lang, interpreterPath, projectType, projectPath, projectName);
    this->close();
}
